...
const links = [
  ...
  },
  {
    ...
    url: 'https://www.wantedly.com/id/keisuke_hirabayashi1',
    color: '#00A4BB',
  },
  {
    name: 'YOUTRUST',
    ...
    url: 'https://youtrust.jp/users/971e265cff5d2ffd723919b5603a7696',
    color: '#2f80ed',
  },
  {
    name: 'Qiita',
    icon: <SiQiita className="w-16 h-16" />,
    url: 'https://qiita.com/hamburger39', 
    color: '#55c500',
  },
  {
    name: 'Zenn',
    icon: <SiZenn className="w-16 h-16" />,
    url: 'https://zenn.dev/k_hirabayashi',
    color: '#3ea8ff',
  },
]
